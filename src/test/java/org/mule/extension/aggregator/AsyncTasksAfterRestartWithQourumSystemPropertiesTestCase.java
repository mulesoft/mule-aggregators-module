...
public class AsyncTasksAfterRestartWithQourumSystemPropertiesTestCase extends AbstractMuleContextTestCase {

  private static final Logger LOGGER = LoggerFactory.getLogger(AsyncTasksAfterRestartWithQourumSystemPropertiesTestCase.class);
